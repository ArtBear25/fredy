 ...
 * @param {Object} [args.replyMarkup] - Inline keyboard payload.
 * @returns {Promise<FormData>}
 */
export async function buildPhotoFormData({ chatId, imageUrl, caption, parseMode, messageThreadId, replyMarkup }) {
