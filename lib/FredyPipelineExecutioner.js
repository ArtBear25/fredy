...
class FredyPipelineExecutioner {
   ...
   * @param {{maxDetailFetches?: number|null, deferNotification?: boolean, forceMissingRoomDetails?: boolean, similarityIgnoredProviders?: string[]}} [options] Run options. `maxDetailFetches` caps how
  ...
  async _fetchDetails(newListings) {
    ...
    const detailsRequestedNormally = providerDetailsEnabled || detailsAlwaysRequired || detailsRequiredForSpatialFilter;
