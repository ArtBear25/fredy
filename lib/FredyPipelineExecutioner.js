...
class FredyPipelineExecutioner {
   ...
   * @param {{maxDetailFetches?: number|null, deferNotification?: boolean, forceDetails?: boolean, forceMissingRoomDetails?: boolean, similarityIgnoredProviders?: string[]}} [options] Run options. `maxDetailFetches` caps how
  ...
  async _prepareApplications(listings, job, userSettings, settings) {
    ...
    for (const listing of listings) {
      ...
      const autoEligible = criteriaMatched && workflowAvailable && wbs.compatible && additionalEligibility.compatible;
