 ...
 * @property {boolean} [fetchDetailsAlways] Fetch details for every new listing even when optional provider details are disabled.
 * @property {boolean} [fetchDetailsForSpatialFilter] Fetch details for new listings when a polygon filter is active, even if optional provider details are disabled.
 * @property {boolean} [requireCoordinatesForSpatialFilter] Withhold unlocated listings before storage and notification when a polygon filter is active.
