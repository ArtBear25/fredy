...
async function fetchDetails(listing) {
  try {
    ...
    return {
      ...listing,
      price: extractNumber(labelled($, $('main'), ['Nettokaltmiete', 'Kaltmiete']) || listing.price),
...
function normalize(raw) {
  ...
  return {
    ...
    // WBM result cards expose Warmmiete. Keep it out of Fredy's price filter; the detail page
    // above supplies the authoritative Nettokaltmiete before the filter is applied again.
    price: null,
