...
import { IconHome, IconMapPin, IconListView, IconBell, IconKey, IconBolt } from '@douyinfe/semi-icons';
...
export default function SettingsLayout() {
  ...
  const tabs = [
    ...
    { path: '/settings/auto-apply', label: t('settings.tabAutoApply'), icon: <IconBolt size="small" /> },
